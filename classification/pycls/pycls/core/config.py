...
# Network output mid layer
_C.MODEL.OUTPUT_MID_LAYER = False

# Best model name
_C.MODEL.SAVE_NAME = "model.pth"
...
# Best top1_err among all epoch
_C.TEST.BEST_TOP1_ERR = 100.0
